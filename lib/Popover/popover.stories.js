...
const _Popover = _interopRequireDefault(require('./Popover'));

const _Toggle = _interopRequireDefault(require('../Toggle/Toggle'));
...
const _default = {
  ...
  component: _Popover.default, // args: {
  //
  // }
...
const Default = function Default(args) {
...
const TargetRef = function TargetRef(args) {
  const PopoverWithRef = /* #__PURE__ */(function (_React$Component) {
    _inherits(PopoverWithRef, _React$Component);

    const _super = _createSuper(PopoverWithRef);
