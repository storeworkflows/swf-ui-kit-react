...
var Popover = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Popover, [{
    ...
    key: "contentResized",
    value: function contentResized() {
      this.resetStyles();
      if (this.state.opened) this.setStylesToContent();
    }
  }, {
    key: "changeOpenedState",
    value: function changeOpenedState(e) {
    ...
    value: function documentClicked(event) {
      ...
      if (currentState && contentElement && targetElement) {
        ...
        if (isOutsideContent && isOutsideTarget) {
          if (!manageOpened) this.changeOpenedState(event);
    ...
    value: function componentDidMount() {
      ...
      (0, _utils.addResizeObserver)(this.targetRef, this.contentResized);
      (0, _utils.addResizeObserver)(this.contentRef.children[0].children[0], this.contentResized);
    }
  }, {
    key: "render",
