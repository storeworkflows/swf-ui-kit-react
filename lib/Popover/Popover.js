...
var Popover = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Popover, [{
    ...
    value: function setStylesToContent() {
      ...
      var contentDimensions = contentElement.getBoundingClientRect(); //  console.log("target", targetDimensions);
      ...
      console.log("transform ", styles); // console.log(contentElement.getBoundingClientRect())
    ...
    value: function componentDidUpdate() {
      ...
      if (this.state.opened) {
        this.setStylesToContent(); // this.changeContentVisibility(visible);
