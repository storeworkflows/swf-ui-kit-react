...
var Popover = /*#__PURE__*/function (_React$Component) {
  ...
  function Popover(props) {
    ...
    _this.setStylesToContent = _this.setStylesToContent.bind(_assertThisInitialized(_this));
    _this.resetStyles = _this.resetStyles(_assertThisInitialized(_this));
    _this.state = {
      opened: false
    };
  ...
  _createClass(Popover, [{
    ...
    value: function componentDidUpdate() {
      ...
      if (this.state.opened) this.setStylesToContent();else this.resetStyles();
    }
  }, {
    key: "render",
