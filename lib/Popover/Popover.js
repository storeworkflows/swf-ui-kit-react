...
var Popover = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Popover, [{
    ...
    value: function updateDimensions() {
      var newTargetDimensions = this.targetRef.current.getBoundingClientRect();
      var newContentDimensions = this.contentRef.current.getBoundingClientRect();
      this.setState({
    ...
    value: function setStylesToContent() {
      ...
      var addTop = parseInt(styles.top.replace("px", ''));
      var addLeft = parseInt(styles.left.replace("px", ''));
      ...
      contentElement.style.visibility = "visible"; // console.log("transform ", styles);
    ...
    key: "changeContentVisibility",
    value: function changeContentVisibility(visibility) {
      var contentElement = this.contentRef.current;
      if (contentElement) contentElement.style.visibility = visibility;
    }
  }, {
    key: "isSameDimensions",
    value: function isSameDimensions(dimensions, dimensionsToCompare) {
      return dimensions.x === dimensionsToCompare.x && dimensions.y === dimensionsToCompare.y && dimensions.height === dimensionsToCompare.height && dimensions.width === dimensionsToCompare.width;
    }
  }, {
    key: "isDimensionsChanged",
    value: function isDimensionsChanged() {
      var currentTargetDimensions = this.targetRef.current.getBoundingClientRect();
    ...
    value: function componentDidUpdate() {
      ...
      } else this.changeContentVisibility(hidden);
    }
  }, {
    key: "render",
