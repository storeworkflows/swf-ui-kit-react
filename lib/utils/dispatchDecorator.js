...
const DispatchDetector = /* #__PURE__ */(function (_React$Component) {
  _inherits(DispatchDetector, _React$Component);

  const _super = _createSuper(DispatchDetector);
  ...
  _createClass(DispatchDetector, [{
    ...
    value: function componentDidMount() {
      const currentNode = _reactDom.default.findDOMNode(this);
