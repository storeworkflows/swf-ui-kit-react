...
var Icon = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)("svg", _objectSpread(_objectSpread({}, this.getAttrs(node.attributes)), {}, {
        style: this.getStyles(),
        className: this.props.className,
        children: _toConsumableArray(node.children).map(function (child, id) {
          var Tag = child.tagName,
              attributes = child.attributes;
          return /*#__PURE__*/(0, React.createElement)(Tag, _objectSpread(_objectSpread({}, _this.getAttrs(attributes)), {}, {
            key: id,
            style: {
              fill: "currentColor"
            }
