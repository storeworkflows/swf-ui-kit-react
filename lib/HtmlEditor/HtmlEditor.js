...
var HtmlEditor = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(HtmlEditor, [{
    ...
    value: function changeInput(editor) {
      var _this$props, _this$props$propertie;

      this.setState({
        inputVal: editor.getData()
      });
      (_this$props = this.props) === null || _this$props === void 0 ? void 0 : (_this$props$propertie = _this$props.properties) === null || _this$props$propertie === void 0 ? void 0 : _this$props$propertie.onValueChange(editor.getData());
    }
  }, {
    key: "render",
