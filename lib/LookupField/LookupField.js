...
var LookupField = /*#__PURE__*/function (_React$Component) {
  ...
  function LookupField(props) {
    ...
    _this.state = {
      ...
      listRecords: {
        value: (_this$props$value$spl = (_this$props$value = _this.props.value) === null || _this$props$value === void 0 ? void 0 : _this$props$value.split(",").filter(Boolean)) !== null && _this$props$value$spl !== void 0 ? _this$props$value$spl : [],
        displayValue: (_this$props$displayVa = (_this$props$displayVa2 = _this.props.displayValue) === null || _this$props$displayVa2 === void 0 ? void 0 : _this$props$displayVa2.split(",").filter(Boolean)) !== null && _this$props$displayVa !== void 0 ? _this$props$displayVa : []
      },
      searchValue: "",
      matchesCount: 0,
      loading: false,
  ...
  _createClass(LookupField, [{
    ...
    value: function render() {
      ...
      var count = listRecords.value.length;
