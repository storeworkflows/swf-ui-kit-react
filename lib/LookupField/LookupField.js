...
var LookupField = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(LookupField, [{
    ...
    value: function componentDidMount() {// console.log("input ref", this.inputRef)
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      var _this$state = this.state,
          ...
          records = _this$state.records; // console.log(records, loading, loaded);
    }
  }, {
    key: "onClick",
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          matchesCount = _this$state2.matchesCount,
          records = _this$state2.records,
          loading = _this$state2.loading,
          loaded = _this$state2.loaded,
          focused = _this$state2.focused,
          referenceRecord = _this$state2.referenceRecord;
