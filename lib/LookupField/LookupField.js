...
var LookupField = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(LookupField, [{
    ...
    key: "deleteValue",
    value: function deleteValue(_ref) {
    ...
    value: function render() {
      ...
      var popoverStyles = {
        'max-height': '20rem',
        'width': "".concat((_this$inputRef = this.inputRef) === null || _this$inputRef === void 0 ? void 0 : (_this$inputRef$curren = _this$inputRef.current) === null || _this$inputRef$curren === void 0 ? void 0 : _this$inputRef$curren.offsetWidth, "px")
      };
