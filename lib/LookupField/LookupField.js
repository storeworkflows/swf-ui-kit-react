...
var LookupField = /*#__PURE__*/function (_React$Component) {
  ...
  function LookupField(props) {
    var _this$props$value$val, _this$props$value, _this$props$value$dis, _this$props$value2, _this$props$value$val2, _this$props$value3, _this$props$value3$va, _this$props$value$dis2, _this$props$value4, _this$props$value4$di;
    ...
    _this.state = {
      ...
      listRecords: {
        value: (_this$props$value$val2 = (_this$props$value3 = _this.props.value) === null || _this$props$value3 === void 0 ? void 0 : (_this$props$value3$va = _this$props$value3.value) === null || _this$props$value3$va === void 0 ? void 0 : _this$props$value3$va.split(",")) !== null && _this$props$value$val2 !== void 0 ? _this$props$value$val2 : [],
        displayValue: (_this$props$value$dis2 = (_this$props$value4 = _this.props.value) === null || _this$props$value4 === void 0 ? void 0 : (_this$props$value4$di = _this$props$value4.displayValue) === null || _this$props$value4$di === void 0 ? void 0 : _this$props$value4$di.split(",")) !== null && _this$props$value$dis2 !== void 0 ? _this$props$value$dis2 : []
      },
      searchValue: "",
      matchesCount: 0,
      loading: false,
