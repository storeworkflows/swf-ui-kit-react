  ...
  function LookupField(props) {
    ...
    _this.onPaste = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
        var value, charsArray, results, _iterator, _step, _loop;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                ...
                results = [];
                _iterator = _createForOfIteratorHelper(charsArray);
                _context3.prev = 12;
                _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
                  var chars, result, _$get, referenceDataList, referenceRecentDataList, records, searchValue;
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          chars = _step.value;
                          _context2.next = 3;
                          return _this.makeRequest(chars);

                        case 3:
                          result = _context2.sent;
                          _$get = _lodash["default"].get(result, "[0].data.GlideLayout_Query.referenceDataRetriever"), referenceDataList = _$get.referenceDataList, referenceRecentDataList = _$get.referenceRecentDataList;
                          records = [].concat(_toConsumableArray(referenceDataList), _toConsumableArray(referenceRecentDataList));
                          searchValue = records.find(function (_ref3) {
                            var referenceData = _ref3.referenceData;
                            return referenceData.some(function (_ref4) {
  ...
  _createClass(LookupField, [{
    ...
    value: function () {
      var _getReferenceList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(value) {
        var data, _$get2, referenceDataList, referenceRecentDataList, totalCount;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                data = _context4.sent;
                _$get2 = _lodash["default"].get(data, "[0].data.GlideLayout_Query.referenceDataRetriever"), referenceDataList = _$get2.referenceDataList, referenceRecentDataList = _$get2.referenceRecentDataList, totalCount = _$get2.totalCount;
                this.setState({
                  loading: false,
                  loaded: true,
                  records: [].concat(_toConsumableArray(referenceDataList), _toConsumableArray(referenceRecentDataList)),
    ...
    key: "deleteValue",
    value: function deleteValue(_ref5) {
      ...
      return visible ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_index.Input, {
            ...
            required: required,
            message: message,
            children: [preloader && this.showPreloader(repeat), isList && this.renderListPills(), !readonly && /*#__PURE__*/(0, _jsxRuntime.jsx)(_index.Input.End, {
