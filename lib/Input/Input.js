...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  function Input(props) {
    ...
    _this.onEvent = _this.onEvent.bind(_assertThisInitialized(_this)); // this.onFocus = this.onFocus.bind(this)
  ...
  _createClass(Input, [{
    ...
    value: function renderStart() {
      ...
      var classes = (0, _classnames3["default"])({
        ...
        "--focused": (_this$state2 = this.state) === null || _this$state2 === void 0 ? void 0 : _this$state2.focused,
        "--readonly": readonly,
        "--disabled": disabled
      });
    ...
    key: "onEvent",
    value: function onEvent(event, type) {
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          ...
          _this$props6$name = _this$props6.name,
          name = _this$props6$name === void 0 ? "name" : _this$props6$name,
          placeholder = _this$props6.placeholder,
          readonly = _this$props6.readonly,
          required = _this$props6.required,
          type = _this$props6.type,
          _this$props6$value = _this$props6.value,
          value = _this$props6$value === void 0 ? this.state.value : _this$props6$value,
      ...
      var labelClasses = (0, _classnames3["default"])({
        "inp-label": true,
        "--moved": _moved,
        "--focused": (_this$state7 = this.state) === null || _this$state7 === void 0 ? void 0 : _this$state7.focused,
      ...
      var requiredClasses = (0, _classnames3["default"])({
        "inp-required": true,
        "--focused": (_this$state9 = this.state) === null || _this$state9 === void 0 ? void 0 : _this$state9.focused,
      ...
      var inputClasses = (0, _classnames3["default"])(_defineProperty({
        "form-control": true,
        "no-start-border": (_this$state11 = this.state) === null || _this$state11 === void 0 ? void 0 : _this$state11.hasStart,
        "no-end-border": (_this$state12 = this.state) === null || _this$state12 === void 0 ? void 0 : _this$state12.hasEnd,
        "--invalid": (_this$state13 = this.state) === null || _this$state13 === void 0 ? void 0 : _this$state13.invalid,
        "--readonly": this.props.readonly
          ...
          children: [_hasLabel && /*#__PURE__*/(0, _jsxRuntime.jsxs)("span", {
            ...
            children: [this.renderStart(), /*#__PURE__*/(0, _jsxRuntime.jsx)("input", {
              ...
              onFocus: function onFocus(e) {
                return _this2.onEvent(e, "onFocus");
              },
              onBlur: function onBlur(e) {
                return _this2.onEvent(e, "onBlur");
              },
              onInput: function onInput(e) {
                return _this2.onEvent(e, "onInput", e.target.value);
              },
