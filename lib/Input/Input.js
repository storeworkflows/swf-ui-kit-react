  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var inputClasses = (0, _classnames3["default"])(_defineProperty({
        "form-control": true,
        "no-start-border": (_this$state3 = this.state) === null || _this$state3 === void 0 ? void 0 : _this$state3.hasStart,
        "no-end-border": (_this$state4 = this.state) === null || _this$state4 === void 0 ? void 0 : _this$state4.hasEnd,
