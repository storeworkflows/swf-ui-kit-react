...
const errorMessage = function errorMessage(error, delay) {
...
const downloadRequest = /* #__PURE__ */(function () {
  const _ref = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee(attachmentSysId, delay) {
    let _window; let _window2; let url; let requestOptions; let response; let data; let
      error;
...
const uploadRequest = /* #__PURE__ */(function () {
  const _ref2 = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee2(file, tableSysId, tableName, delay) {
    let url; let modifiedTableName; let data; let requestOptions; let response; let _data; let
      error;
...
const deleteRequest = /* #__PURE__ */(function () {
  const _ref3 = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee3(attachmentSysId, delay) {
    let url; let requestOptions; let
      response;
