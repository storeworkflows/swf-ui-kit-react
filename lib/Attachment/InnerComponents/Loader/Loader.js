...
const Loader = function Loader(props) {
  const loaderRef = (0, React.useRef)(null);
  (0, React.useEffect)(() => {
    if (loaderRef !== null && loaderRef !== void 0 && loaderRef.current) {
      const parentEl = loaderRef.current.parentElement.parentElement;
  ...
  const containerClasses = (0, _classnames.default)(className, 'swf-loader');
...
const _default = /* #__PURE__ */React.memo(Loader);
