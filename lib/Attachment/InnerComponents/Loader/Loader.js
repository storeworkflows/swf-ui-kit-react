...
var Loader = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Loader, [{
    ...
    value: function componentDidMount() {
      if (this.loaderRef) {
        var parentEl = this.loaderRef.parentElement.parentElement;

        if (parentEl) {
          var styles = getComputedStyle(parentEl);
          this.loaderRef.style.minHeight = "".concat(parentEl.offsetHeight - styles.paddingTop.split('px')[0] - styles.paddingBottom.split('px')[0], "px");
        }
      }
    }
  }, {
