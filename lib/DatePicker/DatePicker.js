...
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    console.log(value);
    var dateValue = value ? (0, _moment["default"])(value, format) : (0, _moment["default"])(new Date(), format);
    console.log(dateValue, dateValue.isValid());
    var isInvalidValue = !dateValue.isValid();
