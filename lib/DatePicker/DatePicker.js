...
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function changeValue(_ref) {
      ...
      var separator = format[2] === 'Y' ? format[4] : format[2];
      var isNumber = input >= '0' && input <= '9'; // if(isNumber){
      //     if()
      // }
    ...
    value: function render() {
      ...
      var separator = format[1]; //let patternValue = `d{2}${separator}d{2}${separator}d{4}`
