...
var GENERATE_FORMATS = function GENERATE_FORMATS() {
  ...
  separators.forEach(function (s) {
    result.push("m".concat(s, "d").concat(s, "y"));
    result.push("m".concat(s, "y").concat(s, "d"));
    result.push("d".concat(s, "m").concat(s, "y"));
    result.push("d".concat(s, "y").concat(s, "m"));
    result.push("y".concat(s, "d").concat(s, "m"));
    result.push("y".concat(s, "m").concat(s, "d"));
  });
  return result;
};
