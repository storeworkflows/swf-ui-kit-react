...
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function changeValue(e) {
      ...
      if (!manageValue) {
        ...
        if ((0, _moment["default"])(newDateString, format, true).isValid()) {
          var minError = (0, _utils.getErrorOnInvalidMinValue)(newDateString, min);
          var maxError = (0, _utils.getErrorOnInvalidMaxValue)(newDateString, max);
    ...
    value: function dateSelected(date) {
      ...
      if (!manageValue) {
        var minError = (0, _utils.getErrorOnInvalidMinValue)(dateInFormat, min);
        var maxError = (0, _utils.getErrorOnInvalidMaxValue)(dateInFormat, max);
    ...
    value: function checkIsInvalid() {
      ...
      if (!manageInvalid && !isValidValue) errorMessages = [invalidFormatMess];else if (isValidValue) {
        var minError = (0, _utils.getErrorOnInvalidMinValue)(stringValue, min);
        var maxError = (0, _utils.getErrorOnInvalidMaxValue)(stringValue, max);
