  ...
  _createClass(Modal, [{
    ...
    value: function componentDidMount() {
      ...
      (_this$modalRef = this.modalRef) === null || _this$modalRef === void 0 ? void 0 : (_this$modalRef$curren = _this$modalRef.current) === null || _this$modalRef$curren === void 0 ? void 0 : _this$modalRef$curren.addEventListener("click", function (event) {
        if (_this4.state.mobileFooterOpened) {
          _this4.setState({
            mobileFooterOpened: false
          });
        }
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      if (this.state.mobileFooterOpened) {
        var footerContentHeight = this.modalRef.current.querySelector(".footer-content").offsetHeight;
      ...
      if (this.props.openModal !== prevProps.openModal) {
        setTimeout(function () {
          _this5.modalRef.current.querySelector(".modal").classList[_this5.props.openModal ? "add" : "remove"]("--opened");
        }, 100);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          headerElements = _this$props.headerElements,
            ...
            children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
                  ...
                  children: (0, _findByType["default"])(this.props.children, "Buttons")
