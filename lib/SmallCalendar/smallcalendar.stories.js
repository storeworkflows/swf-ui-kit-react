...
const _SmallCalendar = _interopRequireDefault(require('./SmallCalendar'));

const _CalendarMonth = _interopRequireDefault(require('./InnerComponents/CalendarMonth'));

const _RengeCalendar = _interopRequireDefault(require('./Renge Calendar'));
...
const Range = function Range(args) {
...
const Month = function Month(args) {
  return /* #__PURE__ */(0, _jsxRuntime.jsx)('div', {
