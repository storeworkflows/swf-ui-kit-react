...
var SmallCalendar = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SmallCalendar, [{
    key: "setDate",
    value: function setDate(day, isActive, e) {
    ...
    key: "changeMonth",
    value: function changeMonth(e, isNext) {
      e === null || e === void 0 ? void 0 : e.stopPropagation();
    ...
    value: function renderCalendarElement(day, isActive, key) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        className: (0, _classnames["default"])({
          ...
          "notActive": !isActive,
          "active": isActive,
          "selected": (0, _utils.isSelected)(openedDate, selectedDate, dayNumber, isActive),
          "now-date": (0, _utils.isNowDate)(openedDate, isActive, dayNumber)
        }),
        onClick: function onClick(e) {
          return _this2.setDate(dayNumber, isActive, e);
        },
        children: day
      }, key);
    }
    ...
    value: function componentDidMount() {
      ...
      if (this.calendarElem) {
        ...
        mc.on("swipeleft", function (e) {
          return _this3.changeMonth(e, true);
        });
        mc.on("swiperight", function (e) {
          return _this3.changeMonth(e, false);
        });
      }
    }
  }, {
    ...
    value: function renderArrowButton(isNext) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        className: classes,
        onClick: function onClick(e) {
          return _this4.changeMonth(e, isNext);
        },
