      ...
      if (!manageSelectedItems) {
        switch (select) {
          ...
          case _constants.DROPDOWN.SELECT.MULTI:
            var findItemIndex = currentSelectedIds.indexOf(id);
            if (findItemIndex === -1) currentSelectedIds.push(id);else currentSelectedIds.splice(findItemIndex, 1);
            break;
    ...
    value: function render() {
      ...
      return visible ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          ...
          }), this.dropdownRef && this.renderItems(), message.map(function (el) {
...
Dropdown.defaultProps = {
  ...
  select: _constants.DROPDOWN.SELECT.MULTI
};
...
Dropdown.propTypes = {
  ...
  icon: _propTypes["default"].string,
  search: _propTypes["default"].oneOf(["none", "managed", "initial", "contains"]),
