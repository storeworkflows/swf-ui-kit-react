...
var Dropdown = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function itemSelected(_ref) {
      ...
      var currentSelected = this.state.selectedItems;
      if (manageSelectedItems) onItemSelected({
    ...
    value: function render() {
      ...
      var hasSelected = selectedItems.length > 0;
      var hasLabel = hasSelected || placeholder;

      var getItemLabelById = function getItemLabelById(id) {
        var result = '';
        items.map(function (el) {
          if (el.id === id) result = el.label;
        });
        return result;
      };
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("style", {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("input", {
            ...
            children: [hasLabel && /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
              ...
              children: hasSelected ? getItemLabelById(selectedItems[0]) : placeholder
