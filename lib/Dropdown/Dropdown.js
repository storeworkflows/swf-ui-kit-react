...
var Dropdown = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function componentDidUpdate() {
      ...
      var container = this.itemsContainerRef;
      var hasSelectedItems = this.state.selectedItems && this.state.selectedItems.length > 0;

      if (manageOpened && opened !== this.state.opened) {
        if (opened && container && hasSelectedItems && scrollToSelected) {
          var selectedEl = container.querySelector("div[data-key=\"".concat(this.state.selectedItems[0], "\"]"));
          selectedEl.scrollIntoView();
        }
