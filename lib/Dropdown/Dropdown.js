...
var Dropdown = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _useState5 = (0, React.useState)((0, _utils.getCorrectSelected)(items, selectedItems)),
      _useState6 = _slicedToArray(_useState5, 2),
      selectedItemsState = _useState6[0],
      setSelectedItemState = _useState6[1];
  ...
  var dropdownClicked = function dropdownClicked() {
    onOpened({
