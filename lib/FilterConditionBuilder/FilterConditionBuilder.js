    ...
    _this.addNewOperator = function (_ref10) {
      ...
      switch (value) {
        ...
        case '^OR':
          ...
          var parrentConditionOptions = newConditionsArray[globalConditionIndexInArr].relatedConditions[currentConditionIndexInArr].conditionOptions;
  ...
  _createClass(FilterCondition, [{
    ...
    value: function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        ...
        var _this$props3, table, user, query, queryParams;

        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _this$props3 = this.props, table = _this$props3.table, user = _this$props3.user;
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(prevProps, prevState) {
        ...
        var onSendQuery, table, queryParams, _this$props4, _table, user;
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          user = _this$props5.user; // console.log("%c%s", "color: green", "REACT Filter Conditions Array", this.state.conditionsArray)
