  ...
  _createClass(FilterCondition, [{
    ...
    value: function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        ...
        var _this$props, table, user, onSendQuery, _this$state3, query, conditionsArray, isSave, queryParams;

        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _this$props = this.props, table = _this$props.table, user = _this$props.user, onSendQuery = _this$props.onSendQuery;
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(prevProps, prevState) {
        ...
        var onSendQuery, _this$state$query, table, queryParams, _this$props2, _table, user;
            ...
            switch (_context7.prev = _context7.next) {
              case 0:
                if (prevProps.table !== this.props.table) {
                  onSendQuery = this.props.onSendQuery;
                  this.setState({
                    query: "",
                    breadcrumbsItems: [{
                      label: 'All',
              ...
              case 6:
                this.setState({
                  ...
                  count: (_this$state$query = this.state.query) === null || _this$state$query === void 0 ? void 0 : _this$state$query.split(/\^|\^OR/).length
                });

              case 7:
                if (this.state.isFilterSaved) {
                  _this$props2 = this.props, _table = _this$props2.table, user = _this$props2.user;
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          user = _this$props3.user; // console.log("%c%s", "color: green", "REACT Filter Conditions Array", this.state.conditionsArray)
