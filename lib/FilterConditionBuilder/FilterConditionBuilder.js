...
var FilterCondition = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterCondition(props) {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                result = _ref3.result, properties = _ref3.properties;
                fieldsDataID = (0, _utils.generateID)();
                blockFields = properties.blockFields, allowFileds = properties.allowFileds;
                query = _this.state.query;
                fieldsDropdownData = (0, _utils.getDropdownFieldsItems)({
              ...
              case 20:
                ...
                operators = (0, _utils.getOperators)(result.columns);
                _context4.next = 24;
                return Promise.all(conditionsArray.map( /*#__PURE__*/function () {
                  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(globalCond) {
                        ...
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            return Promise.all(globalCond.relatedConditions.map( /*#__PURE__*/function () {
                              var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(parentCond) {
                                  ...
                                  while (1) {
                                    switch (_context2.prev = _context2.next) {
                                      case 0:
                                        ...
                                        if (!(parentCond.condition.slice(0, parentCond.condition.indexOf((0, _utils._findOperator)(parentCond.condition, operators))).split(".").length > 1)) {
                                          _context2.next = 7;
                                          break;
                                        }

                                        _context2.next = 4;
                                        return _this.test(params);
                                      ...
                                      case 8:
                                        ...
                                        return Promise.all(parentCond.relatedConditions.map( /*#__PURE__*/function () {
                                          var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(childCond) {
                                            var params, conditionOptions;
                                              ...
                                              while (1) {
                                                switch (_context.prev = _context.next) {
                                                  case 0:
                                                    ...
                                                    if (!(childCond.condition.slice(0, childCond.condition.indexOf((0, _utils._findOperator)(childCond.condition, operators))).split(".").length > 1)) {
                                                      _context.next = 7;
                                                      break;
                                                    }
    ...
    _this.setOperatorsArray = function (_ref8) {
      var result = _ref8.result;
    };

    _this.runButtonClicked = function (_ref9) {
      var type = _ref9.type;
    ...
    _this.generateQuery = function (_ref10) {
    ...
    _this.isFilterSaved = function (_ref11) {
      var isSaved = _ref11.isSaved;
    ...
    _this.addNewOperator = function (_ref12) {
    ...
    _this.clearAll = function (_ref13) {
    ...
    _this.setConditionOptionsOperator = function (_ref14) {
      var value = _ref14.value,
          conditionOptions = _ref14.conditionOptions;
    ...
    _this.setConditionOptionsValue = function (_ref15) {
      var value = _ref15.value,
          conditionOptions = _ref15.conditionOptions,
          conditionOption = _ref15.conditionOption;
    ...
    _this.setConditionOptions = function (_ref16) {
      var value = _ref16.value,
          conditionOption = _ref16.conditionOption,
          currentConditionID = _ref16.currentConditionID,
    ...
    _this.setConditionOptionsValueAdditional = function (_ref17) {
      var value = _ref17.value,
          conditionOptions = _ref17.conditionOptions;
      conditionOptions.valueAdditionalData = value;
      return conditionOptions;
    };

    _this.fetchReferenceData = /*#__PURE__*/function () {
      var _ref18 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(table, queryParams) {
    ...
    _this.setConditionOptionsFieldData = function (_ref19) {
      var conditionOptions = _ref19.conditionOptions,
          value = _ref19.value;
      var fieldsDataID = (0, _utils.generateID)();
    ...
    _this.getConditionsIDs = function (_ref20) {
    ...
    _this.setConditionOptionsField = function (_ref21) {
      var conditionOptions = _ref21.conditionOptions,
          value = _ref21.value;
    ...
    _this.breadcrumbItemClicked = function (_ref22) {
    ...
    _this.setQuery = function (_ref23) {
    ...
    _this.deleteCondition = function (_ref24) {
      var currentConditionID = _ref24.currentConditionID,
          globalConditionID = _ref24.globalConditionID;
      var conditionsArray = _this.state.conditionsArray;
      var newConditionsArray = conditionsArray;
    ...
    _this.fetchFilterTemplates = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    ...
    _this.test = _utils.test.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(FilterCondition, [{
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                _context8.next = 4;
                return (0, _utils.fetchTableData)(table, queryParams).then( /*#__PURE__*/function () {
                  var _ref26 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(result) {
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(prevProps, prevState) {
        var _this3 = this;
      ...
      function componentDidUpdate(_x8, _x9) {
