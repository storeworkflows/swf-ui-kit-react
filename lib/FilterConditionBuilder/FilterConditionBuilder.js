  ...
  _createClass(FilterCondition, [{
    ...
    value: function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        ...
        var _this$props, table, user, onSendQuery, filtersListQuery, _this$state3, query, conditionsArray, isSave, queryParams, groupId;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 6;
                return _utils2.REQUEST_UTILS.fetchGroup({
                  sys_id: groupId
                }).then(function (res) {
                  _this2.setState({
                    defaultGroup: {
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(prevProps, prevState) {
        ...
        var _this$props2, onSendQuery, query, table, filtersListQuery, groupId, _table, queryParams, _this$props3, _table2, user;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _this$props2 = this.props, onSendQuery = _this$props2.onSendQuery, query = _this$props2.query, table = _this$props2.table, filtersListQuery = _this$props2.filtersListQuery;
                groupId = filtersListQuery.replace(/.*=/, "");
                this.setQuery({
                  query: query
                });
    ...
    value: function render() {
      ...
      var _this$state4 = this.state,
          ...
          defaultGroup = _this$state4.defaultGroup;
