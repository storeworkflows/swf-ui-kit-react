...
var FilterCondition = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterCondition(props) {
    ...
    _this.generateQuery = function (_ref5) {
      ...
      conditionsArray.forEach(function (globalCond) {
        ...
        _this.setState({
          ...
          return console.log(_this.state.queryToSave);
        });
    ...
    _this.setQuery = function (_ref17) {
    ...
    _this.deleteCondition = function (_ref18) {
      var currentConditionID = _ref18.currentConditionID,
          globalConditionID = _ref18.globalConditionID;
      var conditionsArray = _this.state.conditionsArray;
      var newConditionsArray = conditionsArray;
  ...
  _createClass(FilterCondition, [{
    ...
    function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        var _this$props3, table, query, queryParams;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                // fetchTableData
                _this$props3 = this.props, table = _this$props3.table, query = _this$props3.query;
                queryParams = {
                  sysparm_operators: true,
                  sysparm_get_extended_tables: true,
                  sysparm_keywords: true
    ...
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(prevProps, prevState) {
        var _this3 = this;
    ...
    value: function render() {
      ...
      var _this$state5 = this.state,
          isFilterCollapsed = _this$state5.isFilterCollapsed,
