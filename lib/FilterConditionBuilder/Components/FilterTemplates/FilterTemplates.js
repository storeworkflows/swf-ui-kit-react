...
var FilterTemplates = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterTemplates(props) {
    ...
    _this.filterForFilterList = function (_ref) {
      var value = _ref.value;
      var filterList = _this.props.filterList;
      var searchValue = value.trim();
      var filteredValues = filterList.filter(function (item) {
    ...
    _this.popoverTarget = /*#__PURE__*/React.createRef();
    return _this;
  }
  ...
  _createClass(FilterTemplates, [{
    ...
    value: function render() {
      ...
      var valuesToShow = !!filteredValues.length || !!searchValue ? filteredValues : filterList;
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          className: "popoverTarget",
          ref: function ref(elm) {
            return _this2.popoverTarget.current = elm;
          },
        ...
        }), popoverToogle && this.popoverTarget.current && /*#__PURE__*/(0, _jsxRuntime.jsx)(_index.Popover, {
          manageOpened: true,
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_index.Popover.Content, {
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_PopoverContent["default"], {
              filterList: valuesToShow,
              setQuery: setQuery,
              onSearch: this.filterForFilterList,
              managePopover: this.managePopover,
