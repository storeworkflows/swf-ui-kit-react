...
var FilterTemplates = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterTemplates(props) {
    ...
    _this.handleSelectItem = function (_ref) {
      ...
      var emptyFiltersID = ["all", "advanced"];

      _this.setState({
        selectedItem: clickedItem
      });

      var query = emptyFiltersID.includes(clickedItem === null || clickedItem === void 0 ? void 0 : clickedItem.id) ? "" : (_clickedItem$id = clickedItem === null || clickedItem === void 0 ? void 0 : clickedItem.id) !== null && _clickedItem$id !== void 0 ? _clickedItem$id : "";
      var advanced = (clickedItem === null || clickedItem === void 0 ? void 0 : clickedItem.id) === "advanced";
      setQuery({
        query: query
      });
    ...
    _this.filters = function () {
      ...
      return [].concat(_toConsumableArray(_this.allFilter), _toConsumableArray(filterList.map(function (_ref2) {
      ...
      })), _toConsumableArray(_this.customFilter));
    };
