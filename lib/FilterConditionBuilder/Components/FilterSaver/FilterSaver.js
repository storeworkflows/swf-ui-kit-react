...
const FilterSaver = /* #__PURE__ */(function (_React$Component) {
  _inherits(FilterSaver, _React$Component);

  const _super = _createSuper(FilterSaver);
  ...
  _createClass(FilterSaver, [{
    ...
    value: (function () {
      const _handleSaveClicked = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee() {
        let _this$props; let user; let table; let query; let isFilterSaved; let _this$state; let filterTitle; let radioValue; let groupValue; let filterData; let response; let
          result;
    ...
    value: function render() {
      ...
      const { filterTitle } = _this$state2;
      const { radioValue } = _this$state2;
      const { groupValue } = _this$state2;
      const { isAdmin } = _this$state2;
      const { lookupFieldVal } = _this$state2;
