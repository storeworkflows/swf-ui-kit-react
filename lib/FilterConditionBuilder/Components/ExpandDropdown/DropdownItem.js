...
const DropdownItem = /* #__PURE__ */(function (_React$Component) {
  _inherits(DropdownItem, _React$Component);

  const _super = _createSuper(DropdownItem);
  ...
  function DropdownItem(props) {
    ...
    _this.itemSelected = function (_ref) {
      const { dropdownClicked } = _ref;
      const _this$props = _this.props;
      const { id } = _this$props;
      const { disabled } = _this$props;
      const { onSelectAction } = _this$props;
      const { listIndex } = _this$props;
      if (!disabled) {
        onSelectAction({
          id,
          dropdownClicked,
  ...
  _createClass(DropdownItem, [{
    ...
    value: function render() {
      ...
      const { id } = _this$props2;
      const { expandIcon } = _this$props2;
      const { label } = _this$props2;
      const { disabled } = _this$props2;
      const { isSelected } = _this$props2;
      const { reference } = _this$props2;
      const { isDropdown } = _this$props2;
