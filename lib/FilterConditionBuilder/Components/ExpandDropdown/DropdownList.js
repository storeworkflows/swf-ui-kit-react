...
const DropdownList = /* #__PURE__ */(function (_React$Component) {
  _inherits(DropdownList, _React$Component);

  const _super = _createSuper(DropdownList);
  ...
  _createClass(DropdownList, [{
    ...
    value: function render() {
      ...
      const { items } = _this$props2;
      const { expandIcon } = _this$props2;
      const { selectedItems } = _this$props2;
      const { onSelectAction } = _this$props2;
      const { listIndex } = _this$props2;
