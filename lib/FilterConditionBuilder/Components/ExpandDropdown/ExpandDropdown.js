...
var ExpandDropdown = /*#__PURE__*/function (_React$Component) {
  ...
  function ExpandDropdown(props) {
    ...
    _this.getFirstListRef = function (_ref) {
      var elm = _ref.elm,
          index = _ref.index;

      if (index === 0 && !_this.firstListRef.current) {
        _this.firstListRef.current = elm;
        !!_this.firstListRef.current ? _this.setState({
          clientWidth: _this.firstListRef.current.clientWidth
        }, function () {
          return console.log(_this.state);
        }) : function () {
          return void 0;
        };
        console.dir(_this.firstListRef.current);
      }
    };
              ...
              return opened && /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
                children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_DropdownList["default"], {
                  ref: function ref(elm) {
                    return _this2.getFirstListRef({
                      elm: _reactDom["default"].findDOMNode(elm),
                      index: index
                    });
                  },
                  ...
                  listIndex: index,
                  autofocus: autofocus,
                  getFirstListRef: _this2.getFirstListRef
