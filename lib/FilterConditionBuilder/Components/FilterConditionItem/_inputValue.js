...
var inputValue = function inputValue(_ref) {
  ...
  switch (editor) {
    ...
    case "choice_dynamic":
    case "reference":
      var table = conditionOptions.fieldItems.items.length < 2 ? generalTable : conditionOptions.fieldItems.items[conditionOptions.fieldItems.items.length - 2].table; // const table = selectedItem.items.length < 2 ? generalTable : selectedItem.items[selectedItem.items.length - 2].table;

      var name = conditionOptions.fieldItems.items[conditionOptions.fieldItems.items.length - 1].id;
      var label = conditionOptions.fieldItems.items[conditionOptions.fieldItems.items.length - 1].label;
      return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
