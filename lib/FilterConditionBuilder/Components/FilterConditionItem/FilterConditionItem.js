...
var FilterConditionItem = /*#__PURE__*/function (_React$Component) {
  ...
  function FilterConditionItem(props) {
    ...
    _this.updateSelectedItem = function (_ref4) {
      ...
      var setConditionOptions = _this.props.setConditionOptions;
      var items = _this.state.selectedItem ? _utils.GENERAL_UTILS.clone(_this.state.selectedItem.items) : [];
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [operatorType === '^OR' ? /*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_ExpandDropdown["default"], {
            ...
            selectedItems: conditionObj.conditionOptions.fieldItems ? conditionObj.conditionOptions.fieldItems.items.map(function (item) {
              return item.id;
            }) : [],
        ...
        }), (0, _inputValue.inputValue)(this.state, conditionObj.conditionOptions, this.itemClicked, this.onDatePickerChange, this.inputValueSet, this.textAreaValueSet), operatorType !== "^OR" && isBtnsRender && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
