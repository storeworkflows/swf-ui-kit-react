  ...
  function FilterConditionItem(props) {
    ...
    _this.operatorsActivation = function () {
      ...
      var _this$state = _this.state,
          column_type = _this$state.activeField.column_type,
    ...
    _this.onItemClicked = function (item) {
      ...
      var _this$state2 = _this.state,
          ...
          refFieldValue = _this$state2.refFieldValue;
      var queryParams = {
  ...
  _createClass(FilterConditionItem, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          clickBtn = _this$props2.clickBtn,
          conditionsArray = _this$props2.conditionsArray;
