...
const _FilterBreadcrumbItem = _interopRequireDefault(require('./FilterBreadCrumbItem/FilterBreadcrumbItem'));
...
const FilterBreadcrumbs = /* #__PURE__ */(function (_React$Component) {
  _inherits(FilterBreadcrumbs, _React$Component);

  const _super = _createSuper(FilterBreadcrumbs);
