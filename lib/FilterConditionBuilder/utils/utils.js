...
exports.generateCurrentConditionQuery = exports.parseConditionValue = exports.parseConditionValueWithRef = exports.getValueAdditionalData = void 0;
...
var generateCurrentConditionQuery = function generateCurrentConditionQuery(conditionData, operation, breadcrumbItem) {
  ...
  if (field && operator && operation === 'run') {
    ...
    if (conditionQuery) {
      var conditionOperatorLabel = editor === "none" ? operatorsArray.find(function (op) {
