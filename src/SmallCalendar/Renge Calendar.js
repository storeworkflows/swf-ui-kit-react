...
import {
  getDefinedDate, getExtremeDates, updateExtremeDates, useWrappedState,
} from './utils';
...
const RangeCalendar = React.forwardRef((props, ref) => {
  ...
  const renderArrows = useCallback((isNext) => (isNext
    ? (
  ...
  return (
    <div className="range-calendar-container" ref={ref}>
