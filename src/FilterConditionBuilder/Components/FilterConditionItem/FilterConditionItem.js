...
export default class FilterConditionItem extends React.Component {
    ...
    textAreaValueSet = ({value}) => {
        ...
        this.setState({textAreaValue: value}, () => setConditionOptions({ value: this.state.textAreaValue, currentConditionID: conditionID, globalConditionID, conditionOption: "value"}))
    }
