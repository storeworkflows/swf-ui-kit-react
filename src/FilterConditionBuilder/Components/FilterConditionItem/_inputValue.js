...
export const inputValue = ({ inputValuePayload }) => {
  const {
    state, conditionOptions, itemClicked, onDatePickerChange, inputValueSet, textAreaValueSet, lookupFieldValueSet,
  } = inputValuePayload;
  const {
    dropdownsIsActive, selectedItem, generalTable, refFieldValue,
  } = state;
  const { operator: { editor } } = conditionOptions;

  const dropdownValueHandle = ({ item, index }) => {
    const newItem = index ? { ...item, index } : { ...item };
    itemClicked(newItem);
  };
  ...
  switch (editor) {
    ...
    case 'choice_multiple':
      const selectedItems = conditionOptions.value ? conditionOptions.value.split(',') : [''];
      return (
      ...
      return (
        <>
          <div className="dropdown-container relative-field-dropdown">
            <Dropdown
              items={[{
                id: 'after', label: 'after', dropdown: 'value', type: 'relative-field', index: '0',
              }, {
                id: 'before', label: 'before', dropdown: 'value', type: 'relative-field', index: '0',
              }]}
          ...
          <div className="dropdown-container relative-field-dropdown">
            <Dropdown
              items={[{
                id: 'minute', label: 'Minutes', dropdown: 'value', type: 'relative-field', index: '2',
              }, {
                id: 'hour', label: 'Hours', dropdown: 'value', type: 'relative-field', index: '2',
              }, {
                id: 'dayofweek', label: 'Days', dropdown: 'value', type: 'relative-field', index: '2',
              }, {
                id: 'month', label: 'Months', dropdown: 'value', type: 'relative-field', index: '2',
              }, {
                id: 'quarter', label: 'Quarters', dropdown: 'value', type: 'relative-field', index: '2',
              }, {
                id: 'year', label: 'Years', dropdown: 'value', type: 'relative-field', index: '2',
              }]}
          ...
          <div className="dropdown-container relative-field-dropdown">
            <Dropdown
              items={[{
                id: 'ago', label: 'ago', dropdown: 'value', type: 'relative-field', index: '3',
              }, {
                id: 'ahead', label: 'from now', dropdown: 'value', type: 'relative-field', index: '3',
              }]}
      ...
      return (
        <>
          <div className="dropdown-container trend-field-dropdown">
            <Dropdown
              items={[{
                id: 'GE', label: 'on or after', dropdown: 'value', type: 'trend_field', index: '0',
              }, {
                id: 'LE', label: 'on or before', dropdown: 'value', type: 'trend_field', index: '0',
              }, {
                id: 'GT', label: 'after', dropdown: 'value', type: 'trend_field', index: '0',
              }, {
                id: 'LT', label: 'before', dropdown: 'value', type: 'trend_field', index: '0',
              }, {
                id: 'EE', label: 'on', dropdown: 'value', type: 'trend_field', index: '0',
              }]}
              selectedItems={[conditionOptions.value['0']]}
              onItemSelected={(item) => dropdownValueHandle({ item: item.clickedItem, index: 0 })}
              select="single"
          ...
          <div className="dropdown-container trend-field-dropdown">
            <Dropdown
              items={[{
                id: 'dayofweek', label: 'day', dropdown: 'value', type: 'trend_field', index: '1',
              }, {
                id: 'month', label: 'month', dropdown: 'value', type: 'trend_field', index: '1',
              }, {
                id: 'quarter', label: 'quarter', dropdown: 'value', type: 'trend_field', index: '1',
              }, {
                id: 'year', label: 'year', dropdown: 'value', type: 'trend_field', index: '1',
              }, {
                id: 'week', label: 'week', dropdown: 'value', type: 'trend_field', index: '1',
              }, {
                id: 'hour', label: 'hour', dropdown: 'value', type: 'trend_field', index: '1',
              }]}
      ...
      return (
        <>
          <div className="dropdown-container glide-date-equivalent-dropdown">
            <Dropdown
              items={[{
                id: 'day', label: 'day', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }, {
                id: 'month', label: 'month', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }, {
                id: 'quarter', label: 'quarter', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }, {
                id: 'year', label: 'year', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }, {
                id: 'week', label: 'week', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }, {
                id: 'hour', label: 'hour', dropdown: 'value', type: 'glide_date_equivalent', index: '0',
              }]}
              selectedItems={[conditionOptions.value['0']]}
              onItemSelected={(item) => dropdownValueHandle({ item: item.clickedItem, index: 0 })}
              select="single"
      ...
      return (
        <>
          ...
          <div className="dropdown-container glide-date-comparative-dropdown">
            <Dropdown
              items={[{
                id: 'day', label: 'day', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }, {
                id: 'month', label: 'month', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }, {
                id: 'quarter', label: 'quarter', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }, {
                id: 'year', label: 'year', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }, {
                id: 'week', label: 'week', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }, {
                id: 'hour', label: 'hour', dropdown: 'value', type: 'glide_date_comparative', index: '1',
              }]}
              selectedItems={[conditionOptions.value['1']]}
              onItemSelected={(item) => dropdownValueHandle({ item: item.clickedItem, index: 1 })}
              select="single"
          ...
          <div className="dropdown-container glide-date-comparative-dropdown">
            <Dropdown
              items={[{
                id: 'before', label: 'before', dropdown: 'value', type: 'glide_date_comparative', index: '2',
              }, {
                id: 'after', label: 'after', dropdown: 'value', type: 'glide_date_comparative', index: '2',
              }, {
                id: 'before or after', label: 'before or after', dropdown: 'value', type: 'glide_date_comparative', index: '2',
              }]}
              selectedItems={[conditionOptions.value['2']]}
              onItemSelected={(item) => dropdownValueHandle({ item: item.clickedItem, index: 2 })}
              select="single"
