...
const Preloader = React.forwardRef((props, ref) => {
    ...
    const {count, items, width, height, flexDirectionGeneral, background, mainStyles, blur} = props;

    return (
        <div
            className="swf-preloader" style={{flexDirection: flexDirectionGeneral, flexWrap: 'wrap'}}
            ref={ref}
        >
